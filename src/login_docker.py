...
def login(url_login, data_login, headers):
    ...
    and through the Chrome browser via Selenium.
    ...
    # Run the Chrome browser binaries
    options = Options()
    options.binary_location = r'/opt/headless-chromium'
    ...
    driver = webdriver.Chrome(options=options, executable_path=r'/opt/chromedriver')
